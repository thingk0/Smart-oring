...
public class DatabaseInitializer implements CommandLineRunner {
	...
	private void initializeMap() throws Exception {
		...
		dtos.add(createNode(2, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(4, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(6, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(8, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(10, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(12, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(14, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(16, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(18, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(20, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(22, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(24, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(26, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(28, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(30, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(32, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(34, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(36, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(38, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(40, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(42, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(44, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(46, 0, EAST, ChargerServiceDto.class));
		dtos.add(createNode(48, 0, EAST, ChargerServiceDto.class));
		...
		dtos.add(createNode(6, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(6, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(6, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(6, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(6, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(6, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(6, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(6, 77, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(7, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(7, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(7, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(7, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(7, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(7, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(7, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(7, 77, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(8, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(8, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(8, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(8, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(8, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(8, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(8, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(8, 77, WEST, ConveyorBeltServiceDto.class));

		dtos.add(createNode(13, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(13, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(13, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(13, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(13, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(13, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(13, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(13, 77, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(14, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(14, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(14, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(14, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(14, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(14, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(14, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(14, 77, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(15, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(15, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(15, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(15, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(15, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(15, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(15, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(15, 77, WEST, ConveyorBeltServiceDto.class));

		dtos.add(createNode(20, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(20, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(20, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(20, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(20, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(20, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(20, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(20, 77, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(21, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(21, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(21, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(21, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(21, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(21, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(21, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(21, 77, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(22, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(22, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(22, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(22, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(22, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(22, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(22, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(22, 77, WEST, ConveyorBeltServiceDto.class));

		dtos.add(createNode(27, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(27, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(27, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(27, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(27, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(27, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(27, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(27, 77, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(28, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(28, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(28, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(28, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(28, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(28, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(28, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(28, 77, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(29, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(29, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(29, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(29, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(29, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(29, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(29, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(29, 77, WEST, ConveyorBeltServiceDto.class));

		dtos.add(createNode(34, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(34, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(34, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(34, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(34, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(34, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(34, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(34, 77, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(35, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(35, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(35, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(35, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(35, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(35, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(35, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(35, 77, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(36, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(36, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(36, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(36, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(36, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(36, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(36, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(36, 77, WEST, ConveyorBeltServiceDto.class));

		dtos.add(createNode(41, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(41, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(41, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(41, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(41, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(41, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(41, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(41, 77, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(42, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(42, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(42, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(42, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(42, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(42, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(42, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(42, 77, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(43, 70, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(43, 71, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(43, 72, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(43, 73, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(43, 74, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(43, 75, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(43, 76, WEST, ConveyorBeltServiceDto.class));
		dtos.add(createNode(43, 77, WEST, ConveyorBeltServiceDto.class));
